...
public class exercise2a extends Configured implements Tool {
	
   public static void main(String[] args) throws Exception {
	 
      int exit = ToolRunner.run(new exercise2a(), args);
      System.exit(exit);
   }
   ...
   public int run(String[] args) throws Exception {
      ...
      job.setJarByClass(exercise2a.class);
     ...
     // FileOutputFormat.setOutputPath(job, new Path("./outdocs/"));
      ...
      FileOutputFormat.setOutputPath(job, new Path(args[1] + "/exer2"));
      ...
      job1.setJarByClass(exercise2a.class);
    ...
    //  FileOutputFormat.setOutputPath(job1, new Path("./outdocs2/"));
      FileInputFormat.setInputPaths(job1, new Path(args[1] + "/exer2"));
      FileOutputFormat.setOutputPath(job1, new Path(args[1] + "/exer2out"));
